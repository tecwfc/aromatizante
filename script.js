...
// Simula o login de administrador (troque para true quando for admin)
const isAdmin = true;

// Produtos ocultos salvos no localStorage
let produtosOcultos = JSON.parse(localStorage.getItem('produtosOcultos')) || [];
